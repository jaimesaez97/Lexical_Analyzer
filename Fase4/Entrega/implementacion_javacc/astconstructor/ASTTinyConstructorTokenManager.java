/* ASTTinyConstructorTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. ASTTinyConstructorTokenManager.java */
package astconstructor;
import astconstructor.*;

/** Token Manager. */
@SuppressWarnings("unused")public class ASTTinyConstructorTokenManager implements ASTTinyConstructorConstants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public ASTTinyConstructorTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public ASTTinyConstructorTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
