...
public class ASTiny {
	...
	public E subtraction(E opnd1, E opnd2) {return new Subtraction(opnd1, opnd2); }
	...
	public E numInt(String st) {return new NumInt(st);}
	...
	public E op(String op1, E opnd1, E opnd2) {
		switch(op1) {
		case ">": return new Mayor(opnd1, opnd2);
		case "<": return new Minor(opnd1, opnd2);
		case ">=": return new MayorEqual(opnd1, opnd2);
		case "<=": return new MinorEqual(opnd1, opnd2);
		case "==": return new Equiv(opnd1, opnd1);
		case "!=": return new NonEquiv(opnd1, opnd2);
		default: return null;
		}
	}
}
