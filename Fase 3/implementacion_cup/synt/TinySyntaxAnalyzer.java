    ...
    private void E2_1(){
        switch(preview.lexClass()){
            ...
            case EOF:
                break;
            default:
                error.syntaxError(preview.row(), preview.lexClass(), LexicalClass.MINOR, LexicalClass.MAYOR, LexicalClass.MINOREQUAL , LexicalClass.MAYOREQUAL , LexicalClass.EQUIV, LexicalClass.DISEQUIV);
    ...
    private void OP(){
        switch(preview.lexClass()){
            ...
            case MAYOR:
                ...
                break;
            case MINOREQUAL:
                pair(LexicalClass.MINOREQUAL);
                break;
            case MAYOREQUAL:
                pair(LexicalClass.MAYOREQUAL);
                break;
            case EQUIV:
                pair(LexicalClass.EQUIV);
                break;
            case DISEQUIV:
                pair(LexicalClass.DISEQUIV);
                break;
            default:
                error.syntaxError(preview.row(), preview.lexClass(), LexicalClass.OPPAR, LexicalClass.VAR, LexicalClass.INT, LexicalClass.REAL, LexicalClass.TRUE, LexicalClass.FALSE);
        }
